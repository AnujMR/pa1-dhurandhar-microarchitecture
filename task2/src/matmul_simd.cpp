...
//                 __m128 bv = _mm_loadu_ps(b + p);

//                 if (rows >= 1) {
//                     __m128 av0 = _mm_loadu_ps(A + static_cast<long>(i) * lda + p);
//                     acc0 = _mm_fmadd_ps(av0, bv, acc0);
//                 }

//                 if (rows >= 2) {
//                     __m128 av1 = _mm_loadu_ps(A + static_cast<long>(i + 1) * lda + p);
//                     acc1 = _mm_fmadd_ps(av1, bv, acc1);
//                 }

//                 if (rows >= 3) {
//                     __m128 av2 = _mm_loadu_ps(A + static_cast<long>(i + 2) * lda + p);
//                     acc2 = _mm_fmadd_ps(av2, bv, acc2);
//                 }

//                 if (rows >= 4) {
//                     __m128 av3 = _mm_loadu_ps(A + static_cast<long>(i + 3) * lda + p);
//                     acc3 = _mm_fmadd_ps(av3, bv, acc3);
//                 }
//             }
...
//             float result0 = hsum128(acc0);
//             float result1 = hsum128(acc1);
//             float result2 = hsum128(acc2);
//             float result3 = hsum128(acc3);
